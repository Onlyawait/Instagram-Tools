...
Module Module1
    ...
    Function Login(user As String, pass As String) As String
        ...
        ElseIf Response.Contains("challenge") Then
            Dim User_id As String = Regex.Match(Response, "\\""user_id\\"": (.*?),").Groups(1).Value
            Dim nonce_code As String = Regex.Match(Response, "\\""nonce_code\\"": \\""(.*?)\\"",").Groups(1).Value
            Return SendEmail($"challenge/{User_id}/{nonce_code}/")
        Else
